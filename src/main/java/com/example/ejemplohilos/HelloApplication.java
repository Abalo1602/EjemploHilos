...
public class HelloApplication extends Application {
    ...
    private Parent createMainView() {
        ...
        Button btnGetHTMLSin = new Button("Get HTML sin hilo");
        btnGetHTMLSin.setOnAction( this::getHTMLSin );

        topControls.getChildren().addAll(label, tfURL, btnGetHTML, btnGetHTMLSin);
    ...
    private void getHTMLSin(ActionEvent evt) {
